	...
	Singleton(this)
{
	...
	win.MouseWheelScrolled.Subscribe(SE_EV_ACTION(Mouse::OnScroll));
	win.MouseButtonPressed.Subscribe(SE_EV_ACTION(Mouse::OnPress));
	win.MouseButtonReleased.Subscribe(SE_EV_ACTION(Mouse::OnRelease));
	win.MouseMoved.Subscribe(SE_EV_ACTION(Mouse::OnMove));
	win.MouseEntered.Subscribe(SE_EV_ACTION(Mouse::OnEnter));
	win.MouseLeft.Subscribe(SE_EV_ACTION(Mouse::OnLeave));
}
