...
public:
	...
	static auto Integer(IntegralType lower, IntegralType upper) -> int
	{
	...
	static auto Real(RealType lower, RealType upper) -> RealType
	{
	...
	static auto Color(bool randomizeAlpha) -> sf::Color
	{
		auto alphaLow = 255;
		if (randomizeAlpha)
		{
		...
		const auto bVec = VecUtils::ConvertTo<sf::Vector4<uchar>>(Vec4(0, 0, 0, alphaLow, 255, 255, 255, 255));
