...
{
	_shadowMapShader.loadFromFile("Resources/Shaders/vertexShader.vert", "Assets/shaders/shadowMap.frag");
	_renderLightsShader.loadFromFile("Resources/Shaders/vertexShader.vert", "Assets/shaders/renderLights.frag");
