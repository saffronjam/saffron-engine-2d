...
void Gui::Init()
{
	...
	auto *newFont = AddFont("Resources/Fonts/segoeui.ttf", 18);
	io.FontDefault = newFont;
	_currentFont = { 18, newFont };

	AddFont("Resources/Fonts/segoeui.ttf", 8);
	AddFont("Resources/Fonts/segoeui.ttf", 12);
	AddFont("Resources/Fonts/segoeui.ttf", 14);
	AddFont("Resources/Fonts/segoeui.ttf", 20);
	AddFont("Resources/Fonts/segoeui.ttf", 22);
	AddFont("Resources/Fonts/segoeui.ttf", 24);
	AddFont("Resources/Fonts/segoeui.ttf", 28);
	AddFont("Resources/Fonts/segoeui.ttf", 32);
	AddFont("Resources/Fonts/segoeui.ttf", 56);
	AddFont("Resources/Fonts/segoeui.ttf", 72);
...
bool Gui::Property(const String &name, sf::Vector3f &value, float min, float max, float step, PropertyFlag flags, Optional<Function<void()>> fn)
{
	ImGui::Text(name.c_str());
	ImGui::NextColumn();
