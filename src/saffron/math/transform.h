...
public:
	...
	auto ToSfTransform() const -> sf::Transform;
...
template <typename T>
auto Transform<T>::ToSfTransform() const -> sf::Transform
{
	return sf::Transform(static_cast<float>(m_matrix[0]), static_cast<float>(m_matrix[4]),
	                     static_cast<float>(m_matrix[12]), static_cast<float>(m_matrix[1]),
	                     static_cast<float>(m_matrix[5]), static_cast<float>(m_matrix[13]),
	                     static_cast<float>(m_matrix[3]), static_cast<float>(m_matrix[7]),
	                     static_cast<float>(m_matrix[15]));
}
