...
static ImGui_ImplDX11_Data* ImGui_ImplDX11_CreateBackendData()
{
    IM_ASSERT(g_Data == NULL);
    g_Data = IM_NEW(ImGui_ImplDX11_Data);
    return g_Data;
}
...
static void ImGui_ImplDX11_DestroyBackendData()
{
    IM_DELETE(g_Data);
    g_Data = NULL;
}
...
// Functions
void ImGui_ImplDX11_SetupRenderState(
...
)
{
    ...
    ctx->VSSetShader(vertexShader == nullptr ? bd->pVertexShader : vertexShader, NULL, 0);
    ctx->VSSetConstantBuffers(0, 1, &bd->pVertexConstantBuffer);
    ctx->PSSetShader(pixelShader == nullptr ? bd->pPixelShader : pixelShader, NULL, 0);
